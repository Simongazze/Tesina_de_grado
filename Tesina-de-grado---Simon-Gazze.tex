...
\subsubsection{Análisis del +/- estandarizado por
equipo}\label{anuxe1lisis-del---estandarizado-por-equipo}
...
dentro de su equipo. Esta medida complementa el análisis del +/- por 100
posesiones al identificar la posición relativa de cada jugador dentro de
su plantel. Por ello, valores elevados deben interpretarse
principalmente como un desempeño superior respecto de sus compañeros, y
no como una medida directa de rendimiento individual aislada del
contexto del equipo.
