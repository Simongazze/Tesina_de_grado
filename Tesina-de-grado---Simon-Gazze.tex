...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-26}Jugadores con mayor plus-minus por cada 100 posesiones}
\centering
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{llrrl}
\toprule
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-27}Jugadores con mayor plus-minus por cada 100 posesiones}
\centering
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{llrrl}
\toprule
...
\subsection{Métricas RAPM}\label{muxe9tricas-rapm}
