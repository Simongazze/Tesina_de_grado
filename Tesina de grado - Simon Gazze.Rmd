...
### Análitica deportiva en el básquetbol argentino {-}
...
en ambos casos el valor del $\lambda$ se selecciona mediante validación cruzada. Cabe destacar que, a diferencia de lo que ocurre con la penalización L1 (Sección 6.6.2), la agrupación de los tres coeficientes de un mismo jugador no introducen ninguna diferencia en la penalización Ridge.
