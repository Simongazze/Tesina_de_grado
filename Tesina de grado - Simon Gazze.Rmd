...
"Actualmente el objetivo enfatiza la construcción de un ranking. Te sugiero reformularlo poniendo mayor énfasis en la evaluación y comparación metodológica de los distintos enfoques de estimación (modelo lineal vs. multinomial, distintas penalizaciones, etc.).
El ranking debería presentarse como un resultado del análisis, no como el eje central del trabajo."
