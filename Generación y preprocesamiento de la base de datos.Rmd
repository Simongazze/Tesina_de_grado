...
\begin{center}
Tabla 2: Ejemplo de secuencia de acciones diferenciando cada posesión
\end{center}

| Cuarto | Tiempo   | Acción               | Jugador                     | Equipo  | Tipo de equipo | Posesión |
|--------|----------|----------------------|-----------------------------|---------|---------------|----------|
...
\begin{center}
Tabla 3: Ejemplo de estructura con una fila por posesión y el conteo de puntos en la misma
\end{center}


| Cuarto | Tiempo   | Acción            | Jugador                     | Equipo  | Tipo de equipo | Posesión | Puntos |
|--------|----------|-------------------|-----------------------------|---------|---------------|----------|--------|
