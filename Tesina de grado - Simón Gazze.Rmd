...
La información requerida para armar nuestra base de datos se encuentra subida en páginas webs particulares para cada uno de los partidos que han transcurrido en la temporada, el formato de dichas páginas es el siguiente:

### Generación del listado de links de los partidos
